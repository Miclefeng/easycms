...
class Common_Upload
{
    ...
    private $allowType = ['gif', 'jpg', 'png', 'jpeg'];  //充许上传文件的类型
    private $maxSize = 5242880;  //允上传文件的最大长度 5M
    ...
    private function setFiles($name = "", $tmp_name = '', $size = 0, $error = 0)
    {
        ...
        //分割文件名，取最后一个后缀
        $arrStr = explode('.', trim($name));
        $this->setOption('fileType', strtolower(trim(end($arrStr))));
